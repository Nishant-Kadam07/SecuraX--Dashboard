          ...
          <div className="flex items-center gap-8">
            ...
            <div className="relative hidden lg:block">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-slate-700/50 border border-slate-600 rounded-lg text-sm text-white placeholder-slate-400 focus:outline-none focus:border-slate-500"
              />
            </div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-6 backdrop-blur-md border border-slate-700/50">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="flex items-center gap-2 px-3 py-2 bg-slate-700/50 border border-slate-600 rounded-lg text-sm text-white hover:bg-slate-700">
                Weekly
              ...
              <tbody>
                {devicesData.map((device, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-sm">
                      <button className="px-3 py-1 rounded bg-slate-700/50 border border-slate-600 text-slate-300 hover:bg-slate-700 transition-colors">
                        View
                      </button>
                    </td>
                  </tr>
